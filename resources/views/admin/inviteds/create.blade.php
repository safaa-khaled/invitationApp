                    ...
                    <form method="POST" action="{{ route('inviteds.store') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <br/>
                                    <input type="radio" id="maali" name="title1" value="معالي">
                                     <label for="maali">معالي</label>
                                    <input type="radio" id="saada" name="title1" value="سعادة">
                                    <label for="saada">سعادة</label>
                                    <input type="radio" id="mr" name="title1" value="mr">
                                    <label for="mr">mr</label>
                                    <input type="radio" id="Your Excellency" name="title1" value="Your Excellency">
