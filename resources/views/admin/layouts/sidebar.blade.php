    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="control">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="#"><i class="menu-icon mdi mdi-file-send"></i> الدعوات العامة  </a>
                    </li>
                    ...
                    <li class="nav-item"> <a class="nav-link" href="#"><i class="menu-icon mdi mdi-account-settings"></i> تعديل بيانات الدخول</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="#"><i class="menu-icon mdi mdi-account-plus"></i> إضافة موظفين  </a>
                    </li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div class="collapse" id="eventDay">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="#"><i class="menu-icon mdi mdi-file-send"></i> جميع الدعوات </a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="#"><i class="menu-icon mdi mdi-seat-recline-normal"></i> الكراسي</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="#"><i class="menu-icon mdi mdi-seat-recline-normal"></i> الكراسي الفارغة فقط</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="#"><i class="menu-icon mdi mdi-file-document"></i> تقارير الكراسي</a>
                    </li>
                </ul>
            </div>
        </li>
